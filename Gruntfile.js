...
/* global module */
var themePath = 'docroot/themes/custom/governor/';
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    sass_globbing: {
      dev: {
        files: {
          [themePath + 'scss/_settings.scss']: themePath + 'scss/settings/**/*.scss',
    ...
    concat: {
      ...
      dist: {
        src: [
          themePath + 'js/**/*.js',
          '!' + themePath + 'js/governor.min.js'
        ],
        dest: themePath + 'build/js/governor.min.js'
      }
    },
    uglify: {
      prod: {
        ...
        files: {
          [themePath + 'build/js/governor.min.js']: [themePath + 'build/js/governor.min.js']
        }
      }
    },
    sass: {
      dev: {
        files: {
          [themePath + 'build/css/governor.min.css']: themePath + 'scss/style.scss'
        },
        options: {
          sourceMap: true,
    ...
    postcss: {
      ...
      dev: {
        map: true,
        src: themePath + 'build/css/governor.min.css'
      },
      prod: {
        map: false,
        src: themePath + 'build/css/governor.min.css'
